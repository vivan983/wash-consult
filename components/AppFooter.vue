...
<a
            ...
            class="inline-flex items-center gap-2.5 bg-[#25D366]/15 hover:bg-[#25D366] text-[#25D366] hover:text-white px-4 py-2.5 rounded-xl transition-all duration-300 group"
            aria-label="Chat with us on WhatsApp"
          >
            <svg class="w-5 h-5 shrink-0 transition-transform group-hover:scale-110" fill="currentColor" viewBox="0 0 24 24">
            ...
            <span class="text-sm font-heading font-semibold">Chat on WhatsApp</span>
          </a>
        </div>
